...
import 'schema/wtaufeedback_record.dart';
...
export 'schema/wtaufeedback_record.dart';
...
/// Functions to query WtaufeedbackRecords (as a Stream and as a Future).
Future<int> queryWtaufeedbackRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      WtaufeedbackRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<WtaufeedbackRecord>> queryWtaufeedbackRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      WtaufeedbackRecord.collection,
      WtaufeedbackRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<WtaufeedbackRecord>> queryWtaufeedbackRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
