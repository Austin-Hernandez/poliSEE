...
class _CandidateWidgetState extends State<CandidateWidget> {
  ...
  void initState() {
    ...
    _model.citationTextFieldFocusNode ??= FocusNode();
                                                  ...
                                                  onPressed: () async {
                                                    ...
                                                    await candidateCandidatesRecord!
                                                      ...
                                                      age: int.tryParse(_model
                                                          ...
                                                          .text),
                                                      citation: _model
                                                          .citationTextFieldTextController
                                                          .text,
                                                    ));
                                                  },
                                                  text: 'UPDATE',
                                          ...
                                          Padding(
                                            ...
                                            child: StreamBuilder<UsersRecord>(
                                              ...
                                              builder: (context, snapshot) {
                                                ...
                                                return ToggleIcon(
                                                  onPressed: () async {
                                                    final favCanLastnameElement =
                                                        widget.lastName;
                                                    final favCanLastnameUpdate =
                                                        toggleIconUsersRecord
                                                                .favCanLastname
                                                                .contains(
                                                                    favCanLastnameElement)
                                                            ? FieldValue
                                                                .arrayRemove([
                                                                favCanLastnameElement
                                                              ])
                                                    ...
                                                    await toggleIconUsersRecord
                                                      ...
                                                      ...mapToFirestore(
                                                        {
                                                          'fav_can_lastname':
                                                              favCanLastnameUpdate,
                                                        },
                                                      ),
                                                    });
                                                    logFirebaseEvent(
                                                        'CANDIDATE_ToggleIcon_cgybho8i_ON_TOGGLE');
